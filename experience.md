...
- Focused UI reuse or feature-local extension: read `docs/ui-patterns-index.md`, then search [Product Shape](docs/obsidian/engineering-liveops/experience/Product%20Shape.md) and [Style](docs/obsidian/engineering-liveops/experience/Style.md) for the named surface, widget, or interaction and read the matching nearby lessons. Read both complete files only for a new shared widget, page-wide redesign, reference-parity task, tutorial work, cross-room primitive, or UI consistency audit.
