...
UI calls the facade with named events such as `playUiTap()`. The facade hides native Capacitor haptics, browser vibration fallback, cooldowns, and the local enabled preference.
