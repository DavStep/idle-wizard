...
Player level unlocks the first 10 plot buy caps. Permanent advanced capacity research unlocks plot caps 11-20 after enough completed prestiges, but the actual plots are still bought with gold in the current run.
