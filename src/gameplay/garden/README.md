...
Player level unlocks the first 10 plot buy caps before prestige. Permanent advanced capacity research unlocks plot caps 11-20 after enough completed prestiges and makes the researched cap buyable immediately in that run, but the actual plots are still bought with gold.
