...
Fast sell is the manual trader sale path. It uses the same marginal trader quote and demand as shelf auto-sell, then pays only the fast-sell percentage: 80% by default, raised to 85%, 90%, and 95% by emerald research.
