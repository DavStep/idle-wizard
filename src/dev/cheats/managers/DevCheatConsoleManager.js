export class DevCheatConsoleManager {
  ...
  createApi() {
    ...
    return Object.freeze({
      ...
      loadLevel: (level, options) => run('loadLevel', level, options),
      ...
      listDialogs: () => run('listDialogs'),
      listUiSurfaces: () => run('listUiSurfaces'),
      openUi: (surfaceId, options) => run('openUi', surfaceId, options),
      listWidgets: () => run('listWidgets'),
      openWidget: (widgetId, options) => run('openWidget', widgetId, options),
      listButtons: () => run('listButtons'),
