...
const GUILD_TAB_ICON_FILES = Object.freeze([
...
describe('Guild bottom-tab icon assets', () => {
  it.each(GUILD_TAB_ICON_FILES)(
    ...
    (fileName) => {
      ...
      expect(icon.visibleWidth).toBeGreaterThanOrEqual(260);
      expect(icon.visibleHeight).toBeGreaterThanOrEqual(350);
      expect(icon.visibleHeight).toBeLessThanOrEqual(430);
