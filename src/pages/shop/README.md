...
It shows an `npc market` block for automatic NPC sales, a `market stock` block for shared NPC stock, and a `player market` block for player-to-player listings.
