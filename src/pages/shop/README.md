...
The `npc market` tab contains automatic NPC demand sales and shared NPC stock. The `player market` tab contains local player requests and player-to-player listings.
