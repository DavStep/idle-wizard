...
import { WorkshopStatsManager } from './managers/WorkshopStatsManager.js';
import {
...
export class WorkshopPageFacade {
  ...
  constructor({
    ...
    this.statsManager = new WorkshopStatsManager({ gameplayFacade });
    this.actionBarManager.onStatsClick = () => this.statsManager.show();
  }
