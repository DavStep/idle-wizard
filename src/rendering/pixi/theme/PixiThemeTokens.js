...
export const PIXI_ROOT_RUN_ASSETS = Object.freeze({
  ...
  workshopPrestige: 'source:assets/icons/icon-prestige-star.png',
...
export const PIXI_ROOT_RUN_GEOMETRY = Object.freeze({
  ...
  workshopRequestTitleRibbon: Object.freeze({
    sourceInsets: Object.freeze({
      top: 14,
      right: 34,
      bottom: 14,
    ...
    borderInsets: Object.freeze({
      top: 18 * ROOT_RUN_TO_SOURCE_SCALE,
      right: 34 * ROOT_RUN_TO_SOURCE_SCALE,
      bottom: 18 * ROOT_RUN_TO_SOURCE_SCALE,
      left: 34 * ROOT_RUN_TO_SOURCE_SCALE,
    }),
    width: 300 * ROOT_RUN_TO_SOURCE_SCALE,
    height: 38 * ROOT_RUN_TO_SOURCE_SCALE,
    contentInsetX: 34 * ROOT_RUN_TO_SOURCE_SCALE,
    contentGap: 5 * ROOT_RUN_TO_SOURCE_SCALE,
    contentOffsetY: -2 * ROOT_RUN_TO_SOURCE_SCALE,
    titleFontSize: 20 * ROOT_RUN_TO_SOURCE_SCALE,
    titleLineHeight: 24 * ROOT_RUN_TO_SOURCE_SCALE,
    titleStroke: 3 * ROOT_RUN_TO_SOURCE_SCALE,
    titleMinFontSize: 13,
