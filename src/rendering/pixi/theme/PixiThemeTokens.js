...
export const PIXI_ROOT_RUN_ASSETS = Object.freeze({
  ...
  roomTabActiveDay:
    'source:assets/ui/day-room-tab-top-cap-selected-9slice.png',
  roomTabInactiveDay:
    'source:assets/ui/day-room-tab-top-cap-9slice.png',
  topPanelBackgroundDay:
    'source:assets/ui/day-top-panel-background-9slice.png',
  workshopWindowNight:
