...
export default [
  ...
  defineUiEditorIntegration({
    ...
    properties: [
      ...
      { label: 'Default skin', value: 'clean-inset' },
    ],
    usages: [
      {
    ...
    scenarios: [
      ...
      { fixture: { placeholder: 'Tag', value: 'MOON', valueColor: '#bd9ae1' }, id: 'semantic-color', label: 'Semantic value color', mount: mountTextField },
...
function textFieldAssetFilter({ id }) {
  return id === PIXI_ROOT_RUN_ASSETS.textFieldCleanInset;
}
