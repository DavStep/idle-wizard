...
- Workshop side controls use two fixed top-aligned stacks. Each visible control is placed by its declared left/right side and numeric weight, with hidden controls removed from slot allocation and reduced-motion-safe state transitions.
