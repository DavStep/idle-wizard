...
- `leaderboard_summary`: public view returning each period top ten plus the subscribing player's own row and rank fields.
...
SELECT * FROM potion_recipe_discovery
