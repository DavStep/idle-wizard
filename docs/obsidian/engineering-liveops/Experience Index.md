...
These are the durable experience notes agents use before changing Idle Wizard.
They are readable in Obsidian and authoritative for project memory.
...
| [[engineering-liveops/experience/Development Operations|Development Operations]] | Running local services, QA, releases, deploys, GitHub Pages, APKs, Maincloud, or production operations. |

## Reading Rule

Read `experience.md` first when working from the repo. In Obsidian, start here
when you want to browse the categories directly.

## Maintenance Rule

Add new lessons to the most specific type note. Keep this index limited to
categories and routing, not individual bug notes.
