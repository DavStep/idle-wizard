...
- Researched Garden automation uses one full-width mixed-grid row: align the five-slot soil to the first and third normal soil edges, then place progress plus Brewing-size Seed/Auto/xN controls beneath it. Persist Auto and xN per plot, default legacy Auto on, and render no more than five committed herbs.
